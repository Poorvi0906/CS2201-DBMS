...
-- ----------------------------------------------------------------------------------
-- Lab Experiment 06: Implementation of SQL Aggregation and Grouping: 
-- Demonstrate the use of GROUP BY, HAVING, and ORDER BY clauses.
...
-- root@localhost	RVU-PC-046	8.4.6	2025-09-29 06:02:05
-- ----------------------------------------------------------------------------------
-- PreCoded Relational Schema and Instance.
-- Open the link in browser and Load the HR Schema into your local environment: https://github.com/nomemory/hr-schema-mysql/blob/master/hr-schema-mysql.sql
...
-- ------------------------------------------------------------------------------------
-- PART A: GROUP BY, HAVING, and ORDER BY
-- ------------------------------------------------------------------------------------

-- Question 01: Count the number of employees in each department. Display the department_id and the count.
-- Write the SQL Statement for the above Question

SELECT department_id, COUNT(*) AS employee_count
FROM employees
GROUP BY department_id;
-- Paste the output of above code and comment your output
/* 	1
10	1
20	2
30	6
...
-- ------------------------------------------------------------------------------------
-- Question 02: Find the average salary for each job_id. Display the job_id and the average salary.
-- Write the SQL Statement for the above Question
...
-- ------------------------------------------------------------------------------------
-- Question 03: Find the total salary paid for each department where the total exceeds $50,000.
-- Write the SQL Statement for the above Question
...
-- ------------------------------------------------------------------------------------
-- Question 04: Find departments that have more than 10 employees. Display the department_id and the count.
-- Write the SQL Statement for the above Question
...
-- ------------------------------------------------------------------------------------
-- Question 05: Find the maximum, minimum, and average salary for each department. Only include departments where the maximum salary is at least $10,000.
-- Write the SQL Statement for the above Question
...
-- Paste the output of above code and comment your output
/* 20	13000.00	6000.00	9500.000000
30	11000.00	2500.00	4150.000000
70	10000.00	10000.00	10000.000000
80	14000.00	6100.00	8955.882353
90	24000.00	17000.00	19333.333333
100	12000.00	6900.00	8600.000000
110	12000.00	8300.00	10150.000000 */

-- ------------------------------------------------------------------------------------
-- Question 06: Count how many employees were hired each year. Display the year and the count.
-- Write the SQL Statement for the above Question
...
-- ------------------------------------------------------------------------------------
-- Question 07: Find the job titles where the average salary is greater than $8,000. Display the job_id, job title, and the average salary.
-- Write the SQL Statement for the above Question
 
SELECT j.job_id, j.job_title, AVG(e.salary) AS average_salary
FROM employees e
...
-- Paste the output of above code and comment your output
/* AC_ACCOUNT	Public Accountant	8300.000000
AC_MGR	Accounting Manager	12000.000000
AD_PRES	President	24000.000000
AD_VP	Administration Vice President	17000.000000
FI_MGR	Finance Manager	12000.000000
MK_MAN	Marketing Manager	13000.000000
PR_REP	Public Relations Representative	10000.000000
PU_MAN	Purchasing Manager	11000.000000
SA_MAN	Sales Manager	12200.000000
SA_REP	Sales Representative	8350.000000 */ 

-- ------------------------------------------------------------------------------------
-- Question 08: Find the departments where the average commission percentage is not null. Display the department_id and the average commission percentage.
-- Write the SQL Statement for the above Question
...
80	0.225000 */ 
-- ------------------------------------------------------------------------------------
-- Question 09: Find the count of employees for each manager. Display the manager_id and the count. Order by the count in descending order.
-- Write the SQL Statement for the above Question
...
-- ------------------------------------------------------------------------------------
-- Question 10: Find the total salary for each job in each department. Display the department_id, job_id, and the total salary. Order by department_id and then by total salary in descending order.
-- Write the SQL Statement for the above Question
